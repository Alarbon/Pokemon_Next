        ...
        <div className="relative grid items-center grid-cols-1 lg:grid-cols-3 lg:gap-0 lg:items-stretch lg:min-h-[600px]">
          <div className="flex flex-col justify-center items-center gap-5 p-5">
            ...
            <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
              Aprenderemos como funciona el sistema de rutas estáticas y
              dinámicas, gestionar estados de carga y error, conectar con base
              de datos postgreSQL, deployear tu proyecto en vercel y más
            </p>
